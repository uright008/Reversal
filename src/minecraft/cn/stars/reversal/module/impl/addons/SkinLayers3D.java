...
@ModuleInfo(name = "SkinLayers3D", localizedName = "module.SkinLayers3D.name", description = "Extend your skin with extra layers",
        localizedDescription = "module.SkinLayers3D.desc", category = Category.ADDONS)
