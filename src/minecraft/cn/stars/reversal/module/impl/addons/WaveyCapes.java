...
@ModuleInfo(name = "WaveyCapes", localizedName = "module.WaveyCapes.name", description = "Make your cape waving look better",
        localizedDescription = "module.WaveyCapes.desc", category = Category.ADDONS)
