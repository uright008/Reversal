...
@ModuleInfo(name = "Wings", localizedName = "module.Wings.name", description = "Render a wing on your back",
        localizedDescription = "module.Wings.desc", category = Category.RENDER)
