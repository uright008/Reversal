...
@ModuleInfo(name = "LineGlyphs", localizedName = "module.LineGlyphs.name", description = "Draw lines in world", localizedDescription = "module.LineGlyphs.desc", category = Category.RENDER)
