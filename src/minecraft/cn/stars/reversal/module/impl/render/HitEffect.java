...
@ModuleInfo(name = "HitEffect", localizedName = "module.HitEffect.name", description = "Renders particle effect when you attack someone",
        localizedDescription = "module.HitEffect.desc", category = Category.RENDER)
