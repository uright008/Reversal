...
@ModuleInfo(name = "Animations", localizedName = "module.Animations.name", description = "Display special swing animations.",
        localizedDescription = "module.Animations.desc", category = Category.RENDER)
