...
public class MainGui extends AtomicGui {
    ...
    private final Animation singlePlayerAnimation = new Animation(Easing.EASE_OUT_EXPO, 1500);
    private final Animation multiPlayerAnimation = new Animation(Easing.EASE_OUT_EXPO, 1500);
    private final Animation settingsAnimation = new Animation(Easing.EASE_OUT_EXPO, 1500);
    private final Animation exitAnimation = new Animation(Easing.EASE_OUT_EXPO, 1500);
    public MainGui() {
        super("Main", "a");
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        atomic48.drawStringWithShadow("b", width / 2f - 396, height / 2f - 8, new Color(250,250,250,250).getRGB());
        rp32.drawStringWithShadow("single", width / 2f - 402, height / 2f + 35, new Color(250,250,250,250).getRGB());

        atomic48.drawStringWithShadow("c", width / 2f - 246, height / 2f - 8, new Color(250,250,250,250).getRGB());
        rp32.drawStringWithShadow("multi", width / 2f - 250, height / 2f + 35, new Color(250,250,250,250).getRGB());

        atomic48.drawStringWithShadow("d", width / 2f + 206, height / 2f - 8, new Color(250,250,250,250).getRGB());
        rp32.drawStringWithShadow("settings", width / 2f + 190, height / 2f + 35, new Color(250,250,250,250).getRGB());

        atomic48.drawStringWithShadow("e", width / 2f + 356, height / 2f - 8, new Color(250,250,250,250).getRGB());
        rp32.drawStringWithShadow("exit", width / 2f + 352, height / 2f + 35, new Color(250,250,250,250).getRGB());
