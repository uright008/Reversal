...
public class AnnouncementGui extends AtomicGui {
    ...
    private void loadAnnouncements() {
        ...
        Announcement announcement2 = new Announcement("Reversal 3.0.0-Insider", "2025/5/9", 1)
                .addContent("# Development Code: MOONRISE").mark()
                .addContent("[+] 支持跨版本1.21.5")
                .addContent("[+] 自定义PotionEffect间距")
                .addContent("[+] Interface新增: 去除GUI的背景")
                .addContent("[+] 新增对象池优化性能(暂未实装)")
                .addContent("[/] 优化获取字体大小性能")
                .addContent("[/] 优化Arraylist性能")
                .addContent("[*] 修复PotionEffect BA模式选框位置错误")
                .addContent("[*] 修复模糊背景显示错误")
                .addContent("[*] 修复一些已知问题")
                .addContent("[?] d./.!@[;e!@#.'a^&^$'[t@#$;]h")
                .calcMaxWidth();
        announcements.clear();
