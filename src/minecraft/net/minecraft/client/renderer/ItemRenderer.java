...
public class ItemRenderer
{
    ...
    private void transformFirstPersonFood(float equipProgress, float swingProgress)
    {
        float f = MathHelper.sin(swingProgress * swingProgress * 3.1415927F);
        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * 3.1415927F);
        GlStateManager.rotate(f * -5.0F, 0.0F, 0.0F, 0.0F);
        GlStateManager.rotate(f1 * -5.0F, 0.0F, 0.0F, 0.0F);
