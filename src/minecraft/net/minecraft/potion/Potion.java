...
public class Potion
{
    ...
    private static final Map<ResourceLocation, Potion> potionResourceLocation = Maps.newHashMap();
    ...
    public static final Potion weakness = (new PotionAttackDamage(18, new ResourceLocation("weakness"), true, 4738376))
            ...
            .setImage("weakness")
            .setIconIndex(5, 0)
            .registerPotionAttributeModifier(SharedMonsterAttributes.attackDamage, "22653B89-116E-49DC-9B6B-9971489B5BE5", 2.0D, 0);
    ...
    public static final Potion healthBoost = (new PotionHealthBoost(21, new ResourceLocation("health_boost"), false, 16284963))
            ...
            .setImage("health_boost")
            .setIconIndex(2, 2)
            .registerPotionAttributeModifier(SharedMonsterAttributes.maxHealth, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0D, 0);
    ...
    protected Potion(int potionID, ResourceLocation location, boolean badEffect, int potionColor)
    {
        ...
        potionResourceLocation.put(location, this);
    ...
    public Potion setImage(String string) {
        this.image = new ResourceLocation("reversal/images/ba/potion/" + string + ".png");
        return this;
    }

    public static Potion getPotionFromResourceLocation(String location)
    {
        return potionResourceLocation.get(new ResourceLocation(location));
    }

    public static Set<ResourceLocation> getPotionLocations()
    {
        return potionResourceLocation.keySet();
    }
